...
### The Purpose of University for Me!
...
I believe that the real difference between China and the States is that the CCP is dependant on where the intellectual elites go. In the west, they mainly go into private enterprise whereas in China they must go into governance (other the autocratic regime fails).
