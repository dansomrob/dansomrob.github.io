...
When criticising SAGE we can ask operational questions, such as *given data from country x was realesed on this date, why wasn't it incorpereted into the models until this other date?*. was infomation from other countries used in the models at the correct time. ect
